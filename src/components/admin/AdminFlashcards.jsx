...
export default function AdminFlashcards() {
    ...
    useEffect(() => {
        ...
        if (!localStorage.getItem('linggo_flashcards')) {
            localStorage.setItem('linggo_flashcards', JSON.stringify(flashcardData));
        }
    }, []);
    ...
    const handleDeleteTopic = (topicId) => {
        if (window.confirm("Bạn có chắc chắn muốn xóa chủ đề này? Tất cả các thẻ trong chủ đề sẽ bị xóa.")) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-lg shadow p-4">
                        <h3 className="text-lg font-semibold mb-4">Danh sách chủ đề</h3>
                ...
                <div className="lg:col-span-2">
                    {selectedTopicId ? (
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        ...
                                        {(!selectedTopic?.cards || selectedTopic.cards.length === 0) && (
                                            <tr>
                                                ...
                                                >
                                                    Chưa có thẻ nào trong chủ đề này
                                                </td>
                                            </tr>
                                        )}
                                    </tbody>
                        ...
                        <div className="bg-white rounded-lg shadow p-8 text-center">
                            <p className="text-gray-500">Vui lòng chọn một chủ đề để quản lý thẻ</p>
                        </div>
                    )}
                </div>
            </div>
