            ...
            <div className="bg-white rounded-xl shadow-md px-12 py-10 w-[430px] max-w-full border border-gray-400 flex flex-col items-center">
                ...
                <div className="w-full flex flex-col gap-2">
                    <label className="text-[16px] text-black">
                        ...
                        <input
                            type="text"
                            className="w-full border-0 border-b border-black bg-transparent outline-none text-[15px] py-1"
                            placeholder=""
                        />
                    </label>
                    <label className="text-[16px] text-black relative">
                        ...
                        <input
                            ...
                            className="w-full border-0 border-b border-black bg-transparent outline-none text-[15px] py-1 pr-8"
                            placeholder=""
                        />
                    ...
                    <button
                        ...
                        className="mt-5 w-2/5 self-center bg-[#2998db] text-white rounded-full text-[18px] py-1.5 cursor-pointer font-medium shadow-sm transition-colors hover:bg-[#1877c9]"
                    >
                        Đăng nhập
                    </button>
                </div>
